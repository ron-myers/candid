...
export const metadata = {
  title: 'FAQ & Known Issues - Candid Help',
  description: 'Frequently asked questions about Candid code reviews, known issues, and troubleshooting tips for Claude Code plugin.',
}
...
- Standards: `Technical.md` or `.candid/Technical.md`
